        ...
        <form className={styles.searchForm}>
          <div className={styles.searchCriteria}>
            <div className={styles.criteriaOption}>
              <div className={styles.criteriaHeader}>FILTER YOUR SEARCH</div>
            ...
            <div className={styles.criteriaOption}>
              <div className={styles.criteriaHeader}>SEARCH A LOCATION</div>
              <input type="text" placeholder="City, state, zip code or country" />
            </div>

            <div className={styles.criteriaOption}>
              <div className={styles.criteriaHeader}>POPULAR LOCATIONS</div>
              <div className={styles.childOption}>
